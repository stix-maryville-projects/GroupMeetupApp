...
export const Pollbutton = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`pollbutton ${className}`}
      fill="none"
      height="56"
      viewBox="0 0 56 56"
      width="56"
    ...
    >
      <g className="g" filter="url(#filter0_d_26_162)">
        <rect
          className="rect"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feBlend
            ...
            mode="normal"
            result="effect1_dropShadow_26_162"
          />

          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_26_162"
            mode="normal"
            result="shape"
          />
        </filter>
