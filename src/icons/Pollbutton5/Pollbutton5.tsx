...
export const Pollbutton5 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`pollbutton-5 ${className}`}
      fill="none"
      height="56"
      viewBox="0 0 56 56"
      width="56"
    ...
    >
      <g className="g" filter="url(#filter0_d_28_563)">
        <rect
          className="rect"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feBlend
            ...
            mode="normal"
            result="effect1_dropShadow_28_563"
          />

          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_28_563"
            mode="normal"
            result="shape"
          />
        </filter>
